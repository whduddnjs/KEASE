...
| **번호** | **게재연월** | **논문제목** | **총저자명** | **출처** | **학술지명** | **권(호)** | **학술지** | **구분** | **SCI여부** | **IF** | **국제공동연구** | **논문여부** | **기여도** | **링크** |
|:--|:--:|:--|:--|:--|:--|:--|:--|:--|:--|:--|:--|:--|:--|:--|
...
| **번호** | **게재연월** | **논문제목** | **총저자명** | **출처** | **학술지명** | **권(호)** | **학술지** | **구분** | **SCI여부** | **IF** | **mrnIF** | **국제공동연구** | **기여도** | **링크** |
|:--------:|:------------:|:-----------:|:-----------:|:--------:|:-----------:|:----------:|:----------:|:--------:|:----------:|:------:|:--------:|:---------------:|:--------:|:--------:|
...
| **번호** | **게재연월** | **논문제목** | **총저자명** | **출처** | **학술대회명** | **권(호)** | **학술지** | **구분** | **SCI여부** | **IF** | **국제공동연구 여부** | **기여도** | **링크** |
|:--------:|:------------:|:-----------:|:-----------:|:--------:|:------------:|:----------:|:----------:|:--------:|:----------:|:------:|:---------------------:|:--------:|:--------:|
...
| 6        | 202409       | Performanmce Analysis of HPCG Benchmark | 안민우, 김나연, 빅준규, 정진규 | 2024 한국계산과학공학회 추계학술대회 | N | 100 | [🔗](https://example.com) |
...
| **번호** | **지식재산권 등 명칭** | **국명** | **출원** | **등록** | **기여율** | **활용여부** | **출원인** | **출원일** | **출원번호** | **등록번호** | **등록인** | **등록일** | **링크** |
|:--------:|:-------------------:|:-------:|:-------:|:-------:|:--------:|:--------:|:--------:|:--------:|:----------:|:-----------:|:---------:|:--------:|:--------:|
| 1        | DEVICE AND METHOD FOR IMPROVING APPLICATION PERFORMANCE BASED ON BLOCK SAMPLES | 미국 | 연세대학교 산학협력단 | 미등록 | 30% | 미활용 | 연세대학교 산학협력단 | 2024.10.31 | 18/933709 | 미등록 | 미등록 | 미등록 | [🔗](https://example.com) |
| 2        | CHECKPOINT AND REWIND METHOD AND APPARATUS IN SERVERLESS PLATFORM | 미국 | 연세대학교 산학협력단, 성균관대학교 산학협력단 | 미등록 | 50% | 미활용 | 연세대학교 산학협력단, 성균관대학교 산학협력단 | 2024.12.09 | 18/974346 | 미등록 | 미등록 | 미등록 | [🔗](https://example.com) |

### **9. 지식재산권(국내특허)**

| **번호** | **지식재산권 등 명칭** | **국명** | **출원** | **등록** | **기여율** | **활용여부** | **출원인** | **출원일** | **출원번호** | **등록번호** | **등록인** | **등록일** | **링크** |
|:--------:|:-------------------:|:-------:|:-------:|:-------:|:--------:|:--------:|:--------:|:--------:|:----------:|:-----------:|:---------:|:--------:|:--------:|
| 1        | 심장질환 예측모델 구축 시스템 및 방법 | 대한민국 | 명지대학교 산학협력단 | 미등록 | 100% | 미활용 | 명지대학교 산학협력단 | 2024.10.04 | 10-2024-0134882 | 미등록 | 미등록 | 미등록 | [🔗](https://example.com) |
| 2        | 블록 샘플 기반의 애플리케이션 성능 개선 장치 및 방법 | 대한민국 | 연세대학교 산학협력단 | 미등록 | 30% | 미활용 | 연세대학교 산학협력단 | 2024.10.24 | 10-2024-0146875 | 미등록 | 미등록 | 미등록 | [🔗](https://example.com) |
| 3        | 서버리스 플랫폼에서의 체크포인트 및 리와인드 방법 및 장치 | 대한민국 | 연세대학교 산학협력단, 성균관대학교 산학협력단 | 미등록 | 50% | 미활용 | 연세대학교 산학협력단, 성균관대학교 산학협력단 | 2024.05.21 | 10-2024-0065783 | 미등록 | 미등록 | 미등록 | [🔗](https://example.com) |
